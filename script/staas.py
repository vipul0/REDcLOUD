...
<ul class="sertyp">
    <li class="header">EFS (NFS) </li>
    <li class="grey"><spam> <img src='raw_nfs.png' /></span></li>
    <li class="grey"><a href='efs.py'>Discover</a></li>
  </ul>
</div>

<div class='columns'>
<ul class="sertyp">
    <li class="header">SAMBA</li>
    <li class="grey"><spam> <img src='images/raw_storage.png' /></span></li>
    <li class="grey"><a href='smb.py'>Discover</a></li>
  </ul></div>

<div class='columns'>
<ul class="sertyp">
    <li class="header">EBS (iSCSI)</li>
    <li class="grey"><spam> <img src='images/raw_storage.png' /></span></li>
    <li class="grey"><a href='ebs.py'>Discover</a></li>
  </ul></div>


<div class='columns'>
<ul class="sertyp">
    <li class="header">S3 (sshfs)</li>
    <li class="grey"><spam> <img src='images/raw_storage.png' /></span></li>
    <li class="grey"><a href='s3.py'>Discover</a></li>
  </ul></div>
