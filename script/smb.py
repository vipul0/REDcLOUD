...
<div id="container" class="container-fluid bg-grey">
  <h2 class="text-center">CIFS STORAGE</h2></br >
    <h4 class="text-center">SAMBA SERVICE</h4>
...
class="close" title="Close Modal">&times;</span>
  ...
  <!-- Modal Content -->
  <form class="modal-content animate" action="/script/createsmb.py" method="get">
    ...
    <div class="container">
      ...
      <input class="form-control"  name="Ssize" placeholder="SIZE OF STORAGE IN GB" type="number" min="1" max="20" required>
<br />
<br />
...
<br />
<br />	  
<label><b>BROWSEABLE</b></label>
<input class="form-control" name="browseop" placeholder="YES/NO" type="text" required>
<br />
<br />	  
